...
dataset_dict = datasets.DatasetDict.load_from_disk("./dataset")
...
model = VisionEncoderDecoderModel.from_pretrained(
    "../models/vit-gpt2-japanese-image-captioning_stair-captions-result")
...
training_args = TrainingArguments(
    ...
    output_dir="./models/vit-gpt2-japanese-image-finetuning",
    num_train_epochs=5,
